  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-4 col-12 sign_up_form">
        ...
        <form method="POST" action="{{url('portal/signin')}}" class="authenticate_user" style="margin:auto">
          @csrf  
          ...
          <div class="form-group input_type mb-4" style="position:relative;">
            ...
            <div class="row mt-7 rowsignin">
                ...
                <div class="col-6" style="text-align: center; display: flex; align-items:center; width:100%;"><a href="{{url('/portal/sign_up')}}" style="text-align:center;font-size:20px; padding:10px; color:#999; width:100%;">Sign up <i class="fa fa-long-arrow-right m-l-5"></i></a></div> 
            </div>
