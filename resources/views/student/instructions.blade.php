...
<div onload="noback();" onpageshow="if (event.persisted) noBack();" id="page-wrapper" ng-model="academia" ng-controller="instructions">
	...
	<div class="panel panel-custom col-lg-12" >
					<div class="panel-heading">
						<h1>Instructions <span class="pull-right text-italic">please_read_the_instructions_carefully</span></h1>
					...
					<div class="panel-body instruction no-arrow">
						...
						<div class="row">
							<div class="col-md-12">
								...
								@if($instruction_data=='') --}}
								<ol>
									<li>Total of 1hr minutes duration will be given to attempt all the questions.</li>
						...
						{{-- {!! Form::open(array('url' => 'frontend/start-exam/'.$record->slug, 'method' => 'POST')) !!} --}}
							<div class="col-md-12">
								...
								<br><span class="text-danger" ng-show="!agreeTerms">please_accept_terms_and_conditions</span>

								<div class="text-center">

                                      <button ng-if="agreeTerms" class="btn button btn-lg btn-success">start_exam</button>
